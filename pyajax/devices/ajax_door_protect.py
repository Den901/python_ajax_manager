...
string
Enum:
[ CABLE_BREAK_ISSUE, VOLTAGE_INSTABILITY, SIREN_VOLUME_TEST_REQUIRED, CO_SENSOR_MALFUNCTION, CO_SENSOR_LEVEL_EXCEEDED, SMOKE_DETECTOR_CAMERA_MALFUNCTION, MICROWAVE_SENSOR_CALIBRATION_ERROR, ACCELEROMETER_MALFUNCTION, BAD_INPUT_RESISTANCE, BAD_TEMPERATURE, END_OF_LIFE, HARDWARE_MALFUNCTION, MODEM_MALFUNCTION, WIFI_CONNECTION_FAIL, BATTERY_MALFUNCTION, BATTERY_CHARGE_ERROR, SOFTWARE_MALFUNCTION, FLASH_MALFUNCTION ]
]
color	string
readOnly: true
Enum:
